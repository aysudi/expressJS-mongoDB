...
import { generateAccessToken, generateRefreshToken, verifyAccessToken, } from "../utils/generateJWT.js";
...
export const update = async (id, payload) => await UserModel.findByIdAndUpdate(id, payload, { new: true });
