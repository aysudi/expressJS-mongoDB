...
export const updateSlider = async (
  ...
  try {
    ...
    const updateSlider: any = { ...req.body };
    ...
    if (!updatedSliderResponse) throw new Error("Slider update failed!");
...
export const deleteSlider = async (
  ...
  try {
    ...
    const sliderWithPublicId = slider as { public_id: string };
