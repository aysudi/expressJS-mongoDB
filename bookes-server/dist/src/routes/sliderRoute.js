...
import { deleteSlider, getSliderById, getSliders, postSlider, updateSlider, } from "../controllers/sliderController.js";
...
sliderRouter.post("/", sliderValidate, (req, res, next) => {
...
sliderRouter.patch("/:id", (req, res, next) => {
